...
MACRO_CONFIG_INT(TcZoomCursor, tc_zoom_cursor, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Adjust cursor position for zoom so /tele works correctly when zoomed out")
