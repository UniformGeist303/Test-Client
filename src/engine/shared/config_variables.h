...
MACRO_CONFIG_INT(ClShowhudHealthArmorText, cl_showhud_healtharmor_text, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show health, shields, and ammo as numbers in the HUD")
